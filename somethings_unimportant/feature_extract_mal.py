...
def write_csv(name,label,result):
    with open('../whole_fcg/Benignware_FCG/Result.csv','a+', newline='') as file:
...
def main():
    ...
    GraphPath='/home/kevin/Malware_apicall/'
